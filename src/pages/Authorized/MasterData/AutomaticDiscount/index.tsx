...
const AutomaticDiscount = () => {
  ...
  const {
    isOpen: isOpenAutomaticDiscountDelteModal,
    onOpen: onOpenAutomaticDiscountDelteModal,
    onClose: onCloseAutomaticDiscountDelteModal
  } = useDisclosure();
  const {
    isOpen: isOpenAutomaticDiscountStatusUpdateModal,
    onOpen: onOpenAutomaticDiscountStatusUpdateModal,
    onClose: onCloseAutomaticDiscountStatusUpdateModal
  } = useDisclosure();
        ...
        return (
          <Switch
            ...
            onChange={() => {
              ...
              onOpenAutomaticDiscountStatusUpdateModal();
            }}
          />
        );
      }
          ...
          <HStack>
            ...
            <TableActionButton
              onClickAction={() => {
                ...
                onOpenAutomaticDiscountDelteModal();
              }}
  ...
  const handleDelete = async () => {
    ...
    setChangeId(null);
    refetchData();
    onCloseAutomaticDiscountDelteModal();
  };
